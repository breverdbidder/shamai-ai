-- ShamaiAI Database Schema - FIXED VERSION
...
CREATE TABLE IF NOT EXISTS il_market_signals (
    ...
    price_change_1m_pct DECIMAL(5,2),
    price_change_3m_pct DECIMAL(5,2),
    ...
    -- Additional metrics
    new_vs_used_ratio DECIMAL(4,2),
    outlier_percentage DECIMAL(4,2),
...
-- View 3: Market summary by city (FIXED - using address_city)
...
FROM il_properties
WHERE address_city IS NOT NULL AND status = 'active'
GROUP BY address_city, listing_type
ORDER BY address_city, listing_type;
